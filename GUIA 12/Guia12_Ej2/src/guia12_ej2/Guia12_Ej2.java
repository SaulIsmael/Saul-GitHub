...
public class Guia12_Ej2 {
    ...
    public static void main(String[] args) {
        ...
        Electrodomestico lavadora = new Lavadora(50, 1000d, "Negro", 'C', 40);
        Electrodomestico tv = new Televisor(42, true, 1000d, "Verde", 'F', 25);
        ...
        for (Electrodomestico aux : lista) {
            System.out.println("El precio de "+aux.getClass()+" es $"+aux.getPrecio());
